...
export const DetailPenjualan = () => {
  ...
  if (loading) {
    return <div className="flex justify-center items-center h-screen text-blue-600">Loading...</div>;
  }
  ...
  return (
    ...
    >
      <Breadcrumb links={[{ path: '/kategori', label: 'Home' }, { path: '/penjualan', label: 'Penjualan' }]} />
